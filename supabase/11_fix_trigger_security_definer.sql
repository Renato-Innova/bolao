-- ============================================================
-- Fix trigger: use 'GS' (not 'grupos') AND add SECURITY DEFINER
-- so the function always runs with the postgres superuser's
-- privileges, bypassing any RLS on classificacao_grupos.
